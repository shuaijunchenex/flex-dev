...
def run_all(configs, entry_module: str = "entries.standard", entry_func: str = "main"):
    # Windows may default redirected Python output to a legacy code page such
    # as cp1252.  The training logs contain Unicode separators, so configure
    # both this process and its child jobs to use UTF-8.
