"""
SARA runner strategy — identical to RBLA runner but injects round index
...
class SaraRunnerStrategy(RunnerStrategy):
    """Runner for SARA (uses RBLA aggregation + alignment-aware clients)."""
