"""
Standard trainer — pre-July-7 legacy version (no AMP, no set_to_none).

Identical to the trainer at commit 5067ffe, before the AMP training
booster and train_optimization_config changes.  Useful for A/B testing
whether trainer changes affect round-0 accuracy or convergence.
"""
...
class ModelTrainer_StandardLegacy(ModelTrainer):
    """Pre-July-7 standard trainer: no AMP, original zero_grad, no autocast."""
